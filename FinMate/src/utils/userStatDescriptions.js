...
export const VALUE_SECTION_SUMMARY =
  "당신이 투자에서 가장 중요하게 생각하는 ‘목적’을 보여줘요. 안전 중시부터 고수익 추구까지, 어떤 방향으로 나아가고 싶은지 나타냅니다.";
...
export const VALUE_DESCRIPTIONS = {
  ...
  성장형:
    "높은 수익률을 원하지만 아직 과감한 투자는 망설여져요. 계속 도전 중…!",
...
export const FINANCE_SECTION_SUMMARY =
  "감당할 수 있는 손실 한도를 나타내요. 0% ~ 20%까지, 잃어도 되는 돈의 범위를 보여줍니다.";
...
export const SPEED_SECTION_SUMMARY =
  "투자 목표까지 기다릴 수 있는 기간을 나타내요. 단기 거래부터 장기 보유까지, 투자 속도를 보여줍니다.";
...
export const LUCK_STRATEGY_SECTION_SUMMARY =
  "투자 방식을 나타내요. 철저한 계획형인지, 흐름에 맡기는 감각형인지 알 수 있습니다.";
...
export const ADVENTURE_SECTION_SUMMARY =
  "투자 이해도와 위험 선호도를 함께 보여줘요. 낮은 값은 정보와 경험이 부족해 예·적금 등 안전자산 위주로 선택하고, 높은 값은 경험과 이해도가 높아 펀드 등 고위험 자산까지 적극적으로 고려합니다.";
